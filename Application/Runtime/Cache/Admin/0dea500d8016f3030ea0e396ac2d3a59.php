    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            <li>
              <i class="fa fa-dashboard"></i>  <a href="/admin.php?c=content">课件管理</a>
            </li>
            <li class="active">
              <i class="fa fa-edit"></i> 课件添加
            </li>
          </ol>
        </div>
      </div>
        ...
        <div class="col-lg-6">
          ...
          <form class="form-horizontal" id="singcms-form">
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" name="title" class="form-control" id="inputname" placeholder="请填写教师姓名">
              </div>
            </div>
            <div class="form-group">
...
<script>
  var SCOPE = {
    ...
    'jump_url' : '/admin.php?c=course&a=index',
