    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            <li>
              <i class="fa fa-dashboard"></i>  <a href="/admin.php?c=course">课件管理</a>
            </li>
            <li class="active">
              <i class="fa fa-edit"></i> 课件编辑
            </li>
          </ol>
        </div>
      </div>
        ...
        <div class="col-lg-6">
          ...
          <form class="form-horizontal" id="singcms-form">
            <div class="form-group">
              <label for="inputname" class="col-sm-2 control-label" >课件名称:</label>
              <div class="col-sm-5">
                <input value="<?php echo ($news["title"]); ?>" type="text" name="title" class="form-control" id="inputname" placeholder="请填写标题">
              </div>
            </div>
            <div class="form-group">
              <label for="inputname" class="col-sm-2 control-label">课件标题:</label>
              <div class="col-sm-5">
            ...
            <!--<div class="form-group">-->
              ...
              <!--<div class="col-sm-5">-->
                <!--<input value="<?php echo ($news["author"]); ?>" type="text" name="author" class="form-control" id="inputname" placeholder="请填写作者">-->
              <!--</div>-->
            <!--</div>-->
            <div class="form-group">
              <label for="inputname" class="col-sm-2 control-label">教学课件:</label>
              <div class="col-sm-5">
                <input id="file_upload"  type="file" multiple="true" >
                  <!--<a style="display: none" id="upload_org_code_img" href="<?php echo ($news["thumb"]); ?>" >下载</a>-->
                ...
                <!--<select class="form-control" name="title_font_color">-->
                  <!--<option value="">==请选择颜色==</option>-->
                    <!--<?php if(is_array($titleFontColor)): foreach($titleFontColor as $key=>$color): ?>-->
                      <!--<option value="<?php echo ($key); ?>" <?php if($key == $news['title_font_color']): ?>selected="selected"<?php endif; ?>><?php echo ($color); ?></option>-->
              ...
              <!--<div class="col-sm-5">-->
                <!--<select class="form-control" name="catid">-->
                  ...
                  <!--<?php if(is_array($webSiteMenu)): foreach($webSiteMenu as $key=>$sitenav): ?>-->
                    <!--<option value="<?php echo ($sitenav["menu_id"]); ?>" <?php if($sitenav['menu_id'] == $news['catid']): ?>selected="selected"<?php endif; ?>><?php echo ($sitenav["name"]); ?></option>-->
                  <!--<?php endforeach; endif; ?>-->
                <!--</select>-->
              <!--</div>-->
            <!--</div>-->
              ...
              <!--<div class="col-sm-5">-->
                <!--<select class="form-control" name="copyfrom">-->
                  <!--<?php if(is_array($copyfrom)): foreach($copyfrom as $key=>$cfrom): ?>-->
                    ...
                    <!--<option value="<?php echo ($key); ?>" <?php if($key == $news['copyfrom']): ?>selected="selected"<?php endif; ?>><?php echo ($cfrom); ?></option>-->
                  <!--<?php endforeach; endif; ?>-->
                <!--</select>-->
              <!--</div>-->
            <!--</div>-->
...
<script>
  var SCOPE = {
    'save_url' : '/admin.php?c=course&a=add',
    'jump_url' : '/admin.php?c=course',
