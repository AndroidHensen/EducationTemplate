        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        <li>
                            <i class="fa fa-dashboard"></i> <a href="/admin.php?c=course">教学课件</a>
                        </li>
                        <li class="active">
                            <i class="fa fa-table"></i>课件列表
                        </li>
                    </ol>
                </div>
            </div>
                        ...
                        <form id="singcms-listorder">
                            <table class="table table-bordered table-hover singcms-table">
                                ...
                                <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><a href="<?php echo ($new["thumb"]); ?>">下载</a></td>
...
<script>
    var SCOPE = {
        'edit_url': '/admin.php?c=course&a=edit',
        'add_url': '/admin.php?c=course&a=add',
        'set_status_url': '/admin.php?c=course&a=setStatus',
        'sing_news_view_url': '/index.php?c=view',
        'listorder_url': '/admin.php?c=course&a=listorder',
        'push_url': '/admin.php?c=course&a=push',
    }
</script>
