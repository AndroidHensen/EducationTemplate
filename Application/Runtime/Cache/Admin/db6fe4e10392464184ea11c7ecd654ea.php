        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        <li>
                            <i class="fa fa-dashboard"></i> <a href="/admin.php?c=share">经验介绍</a>
                        </li>
                        <li class="active">
                            <i class="fa fa-table"></i>经验列表
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <form action="/admin.php" method="get">
                    <!--<div class="col-md-3">-->
                        ...
                        <!--</div>-->
                    <!--</div>-->
                    <input type="hidden" name="c" value="share"/>
...
<script>
    var SCOPE = {
        'edit_url': '/admin.php?c=share&a=edit',
        'add_url': '/admin.php?c=share&a=add',
        'set_status_url': '/admin.php?c=share&a=setStatus',
        'sing_news_view_url': '/index.php?c=view',
        'listorder_url': '/admin.php?c=share&a=listorder',
        'push_url': '/admin.php?c=share&a=push',
    }
</script>
