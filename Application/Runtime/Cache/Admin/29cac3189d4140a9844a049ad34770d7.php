        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        <li>
                            <i class="fa fa-dashboard"></i> <a href="/admin.php?c=career">专题介绍</a>
                        </li>
                        <li class="active">
                            <i class="fa fa-table"></i>专题列表
                        </li>
                    </ol>
                </div>
            </div>
                        ...
                        <!--<div class="input-group">-->
                            ...
                            <!--<select class="form-control" name="catid">-->
                                ...
                                <!--<?php if(is_array($webSiteMenu)): foreach($webSiteMenu as $key=>$sitenav): ?>-->
                                    <!--<option value="<?php echo ($sitenav["menu_id"]); ?>"-->
                                    <!--<?php if($type["catid"] == $sitenav['menu_id']): ?>selected="selected"<?php endif; ?>-->
                                    <!--&gt;<?php echo ($sitenav["name"]); ?></option>-->
                                <!--<?php endforeach; endif; ?>-->
                            <!--</select>-->
                        <!--</div>-->
                    <!--</div>-->
                    <input type="hidden" name="c" value="career"/>
                        ...
                        <form id="singcms-listorder">
                            <table class="table table-bordered table-hover singcms-table">
                                ...
                                <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><?php echo ($new["small_title"]); ?></td>
...
<script>
    var SCOPE = {
//        'edit_url': '/admin.php?c=career&a=edit',
        'edit_url': '#',
//        'add_url': '/admin.php?c=career&a=add',
        'add_url': '#',
        'set_status_url': '/admin.php?c=career&a=setStatus',
        'sing_news_view_url': '/index.php?c=view',
//        'listorder_url': '/admin.php?c=career&a=listorder',
        'listorder_url': '#',
        'push_url': '/admin.php?c=career&a=push',
    }
</script>
