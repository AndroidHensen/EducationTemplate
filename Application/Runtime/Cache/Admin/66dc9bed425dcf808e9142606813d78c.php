...
<script>
    var SCOPE = {
        'edit_url': '/admin.php?c=about&a=edit',
        'add_url': '/admin.php?c=about&a=add',
        'set_status_url': '/admin.php?c=about&a=setStatus',
        'sing_news_view_url': '/index.php?c=view',
        'listorder_url': '/admin.php?c=about&a=listorder',
        'push_url': '/admin.php?c=about&a=push',
    }
</script>
