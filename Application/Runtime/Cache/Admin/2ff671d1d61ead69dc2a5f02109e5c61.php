        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        <li>
                            <i class="fa fa-dashboard"></i> <a href="/admin.php?c=teach">教学团队</a>
                        </li>
                        <li class="active">
                            <i class="fa fa-table"></i>团队列表
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <form action="/admin.php" method="get">
                    <!--<div class="col-md-3">-->
                        ...
                        <!--</div>-->
                    <!--</div>-->
                    <input type="hidden" name="c" value="teach"/>
...
<script>
    var SCOPE = {
        'edit_url': '/admin.php?c=teach&a=edit',
        'add_url': '/admin.php?c=teach&a=add',
        'set_status_url': '/admin.php?c=teach&a=setStatus',
        'sing_news_view_url': '/index.php?c=view',
        'listorder_url': '/admin.php?c=teach&a=listorder',
        'push_url': '/admin.php?c=teach&a=push',
    }
</script>
