        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        <li>
                            <i class="fa fa-dashboard"></i> <a href="/admin.php?c=banner">轮播图</a>
                        </li>
                        <li class="active">
                            <i class="fa fa-table"></i> 轮播图列表
                        </li>
                    </ol>
                </div>
            </div>
...
<script>
    var SCOPE = {
        'edit_url': '/admin.php?c=banner&a=edit',
        'add_url': '/admin.php?c=banner&a=add',
        'set_status_url': '/admin.php?c=banner&a=setStatus',
        'sing_news_view_url': '/index.php?c=view',
        'listorder_url': '/admin.php?c=banner&a=listorder',
        'push_url': '/admin.php?c=banner&a=push',
    }
</script>
