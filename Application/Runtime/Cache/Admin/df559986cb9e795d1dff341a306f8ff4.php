    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            <li>
              <i class="fa fa-dashboard"></i>  <a href="/admin.php?c=teach">教师管理</a>
            </li>
            <li class="active">
              <i class="fa fa-edit"></i> 教师编辑
            </li>
          </ol>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <form class="form-horizontal" id="singcms-form">
            ...
            <!--</div>-->
            <div class="form-group">
              <label for="inputname" class="col-sm-2 control-label">教师头像:</label>
              <div class="col-sm-5">
...
<script>
  var SCOPE = {
    'save_url' : '/admin.php?c=teach&a=add',
    'jump_url' : '/admin.php?c=teach',
