        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        <li>
                            <i class="fa fa-dashboard"></i> <a href="/admin.php?c=theme">专题介绍</a>
                        </li>
                        <li class="active">
            ...
            <div class="row">
                <form action="/admin.php" method="get">
                    <!--<div class="col-md-3">-->
                        ...
                        <!--</div>-->
                    <!--</div>-->
                    <input type="hidden" name="c" value="theme"/>
...
<script>
    var SCOPE = {
        'edit_url': '/admin.php?c=theme&a=edit',
        'add_url': '/admin.php?c=theme&a=add',
        'set_status_url': '/admin.php?c=theme&a=setStatus',
        'sing_news_view_url': '/index.php?c=view',
        'listorder_url': '/admin.php?c=theme&a=listorder',
        'push_url': '/admin.php?c=theme&a=push',
    }
</script>
